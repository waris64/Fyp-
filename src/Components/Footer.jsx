...
const Footer = () => {
  return (
    <div className='mt-4 w-screen bg-green-950 text-white flex flex-col md:flex-row justify-around p-5 leading-10'>
      ...
      >
        <h1 className='md:text-4xl text-2xl'>Quick <span className='text-orange-500'>Links </span></h1>
        <ul>
          <li>Home</li>
          <li>Diseases</li>
          <li>About Us</li>
      ...
      transition={{duration:1}}
      >
        <h1 className='md:text-4xl text-2xl'>Contact &nbsp; <span className="text-orange-500">Us</span> </h1>
