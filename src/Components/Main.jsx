 ...
 <br />
      ...
      <section className="flex flex-col md:flex-row md:justify-around md:items-center md:py-8 overflow-hidden p-7">
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <img src={rectangle} className="w-82 p-6 size-82 bg-cover" alt="" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: 100 }}
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, scale: 1 }}
        transition={{ duration: 1 }}
        className="md:mb-5 shadow-2xl overflow-hidden  m-5 shadow-200 h-96 pt-8  flex flex-col items-center justify-center md:w-[87vw]"
      >
